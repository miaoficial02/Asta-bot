...
let drm1 = ""
let drm2 = ""
let rtx = "*╔═[Asta - SubBot QR]═╗*\n*║ Conecta tu Sub-Bot escaneando este código QR con otro celular. Abre WhatsApp, toca Dispositivos vinculados y escanea este código QR. El código QR expira en 45 segundos. ║*\n*╚════════════════╝*"
let rtx2 = "`*╔═══[Asta - SubBot Code]═══╗*\n*║ Conecta tu Sub-Bot con este código:* \n*║ 1. Abre WhatsApp en tu celular.* \n*║ 2. Toca Dispositivos vinculados.* \n*║ 3. Selecciona Vincular con el número de teléfono.* \n*║ 4. Escribe el código.* \n*║ No uses tu cuenta principal.* \n*╚══════════════════╝*"
